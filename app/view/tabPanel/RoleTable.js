	...
	getRegieContent = function (regieName, dbid) {
            var toolBarGlobal = Ext.getCmp('toolbar');
                   ...
                   // if(!isHistoryItemExist){
                          var menuItem = historyButton.menu.add({text: '<font style="color:gray;">' + regieName + '</font>', icon: 'resources/images/theatreB.png'});  //, selection: 3
					...
					var personDetails = new TheaterTool.view.tabPanel.roles.RolePanelInTab({dbkey: dbid, icon: 'resources/images/theatreB.png', title: '<font size="2" face="Arial" style="color:#A87678;">Role: ' + regieName + '</font>'
                });
