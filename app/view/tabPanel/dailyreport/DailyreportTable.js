Ext.define('TheaterTool.view.tabPanel.dailyreport.DailyreportTable', {
    ...
    initComponent: function () {
        ...
        if (column_2) {
            var col_inhalt_1 = this.createColumn('Vorstellungen', 'resources/images/Note-15.png', 'work_2', me.selectedWorkID);
            tableColumns = tableColumns + 1;
        ...
        getPersonContent = function (personId, personName) {
            ...
            if (! isFoundItem) {
                ...
                var personDetails = new TheaterTool.view.tabPanel.persons.PersonPanelInTab({
                    ...
                    title: '<font style="color:gray;"">Person: ' + personName + '</font>'
                });
                repertoireTab.add(personDetails);
