    ...
    createColumn: function (headerName, path) {
        ...
        getPlanContent = function (jahr, monat) {
            ...
            var menuItem = historyButton.menu.add({
                text: '<font style="color:gray;">'+GUI_NAMES.work_SectionPlayschedules_tailName+': ' + monat + ', ' + jahr + '</font>', icon: 'resources/images/Calendar-17.png'
            });
            //, selection: 3
            ...
            var isFoundItem = navTreeGlobal.isItemFound(existItems, '<font style="color:gray;">'+GUI_NAMES.work_SectionPlayschedules_tailName+': ' + monat + ', ' + jahr + '</font>', menuItem.id);
            if (! isFoundItem) {
                var repertoireTab = new TheaterTool.view.tabPanel.HTTab({
                    title: '<font style="color:gray;">' +GUI_NAMES.work_SectionPlayschedules_tailName+': '+ monat + ', ' + jahr + '</font>',
                    icon: 'resources/images/Calendar-17.png'
                });
                var personDetails = new TheaterTool.view.tabPanel.playSchedules.SchedulePanelInTab({
                    year: jahr, monat: monat, selectedWorkID: me.selectedWorkID
                });
