 ...
 * @class
 */
Ext.define('TheaterTool.view.tabPanel.persons.PersonPanelDetails', {
...
this.dsection_xml = new TheaterTool.view.tabPanel.persons.PersonTabXML({sourceID: this.sourceID});
this.items = [
