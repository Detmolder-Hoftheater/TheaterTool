            ...
            var toolBarGlobal = Ext.getCmp('toolbar');
             var nameForLoad = jahr.split(':');
                    ...
                    //if(!isHistoryItemExist){
                          var menuItem = historyButton.menu.add({text: '<font style="color:gray;">' + roleNameToHistory + '</font>', icon: 'resources/images/Presse-16.png'});  //, selection: 3
					...
					var personDetails = new TheaterTool.view.tabPanel.journal.JournalPanelInTab({regieName: roleName, count: countFoSelection, dbkey: me.dbkey});
