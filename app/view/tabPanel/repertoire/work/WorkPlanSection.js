...
style: {
  ...
  /*  features: [{
    ...
    me.personTable = new TheaterTool.view.tabPanel.repertoire.work.PlanTable();
    me.repertoireTab = new TheaterTool.view.tabPanel.repertoire.work.PlanDetailsTabPanel();
