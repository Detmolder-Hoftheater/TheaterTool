Ext.define('TheaterTool.view.tabPanel.roles.RolePanelInTab', {
    ...
    initComponent: function () {
        ...
        me.section_details = new TheaterTool.view.tabPanel.roles.RoleTabDetails({
        ...
        me.listeners = {
            ...
            afterrender: function (panel) {
                this.header.insert(1,[ {
                    ...
                    menu:[ {
                        xtype: 'textarea',
                        value: 'https://portal.hoftheater-detmold.de/index.html#HoftheaterDetmold:rolle_' + me.dbkey,
                        plain: true,
                        readOnly: true,
                        inputWrapCls: '',
                        triggerWrapCls: '',
