...
/*layout: {
    ...
    initComponent: function () {
        ...
        var workPanel = new TheaterTool.view.tabPanel.repertoire.work.WorkPanelDetails({workID: me.selection, title:'<font size="2" face="Arial" style="color:#A87678;">Werk: '+me.workName+'</font>', icon: me.workIcon});
