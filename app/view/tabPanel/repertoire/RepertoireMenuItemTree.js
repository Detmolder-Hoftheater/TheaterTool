	   ...
	   var me = this;
		...
		this.listeners = {
			...
			selectionchange: function (selected, eOpts) {
				...
				console.log(eOpts[0].data);
					me.repertoirePanel.removeAll(true);
					me.beatPanel = new TheaterTool.view.tabPanel.repertoire.beat.BeatPanel({selectedWork: me.selectedWork, xmlId: eOpts[0].data.xmlid, title: '<font size="2" face="Arial" style="color:#A87678;">Faksimiles für '+eOpts[0].data.name+' ('+eOpts[0].parentNode.parentNode.data.name+')</b>'});
