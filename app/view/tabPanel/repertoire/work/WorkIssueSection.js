...
Ext.define('TheaterTool.view.tabPanel.repertoire.work.WorkIssueSection', {
  ...
  /*  features: [{
    ...
    me.personTable = new TheaterTool.view.tabPanel.repertoire.work.IssueTable();
    me.repertoireTab = new TheaterTool.view.tabPanel.repertoire.work.IssueDetailsTabPanel();
