Ext.define('TheaterTool.view.tabPanel.repertoire.RepertoireNavigationTree', {
    ...
    initComponent: function () {
            ...
            selectionchange: function (selected, eOpts) {
                if (typeof eOpts[0] !== 'undefined' && eOpts[0].data.depth === 1) {
                    ...
                    me.workPanel = new TheaterTool.view.tabPanel.repertoire.work.WorkPanelDetails({
                        workID: eOpts[0].data.werkID, title: '<font size="2" face="Tahoma" style="color:#909090;">Werk: ' + eOpts[0].data.name + '</font>', icon: workIcon
                    });
                    ...
                    me.sourcePanel = new TheaterTool.view.tabPanel.repertoire.source.SourcePanel({
                        sourceID: eOpts[0].data.sourceID, werkTitle: eOpts[0].parentNode.data.name, title: '<font size="2" face="Tahoma" style="color:#909090;">' + eOpts[0].data.name + '</font>', firstTabTitle: eOpts[0].data.physLocation, icon: workIcon
                    });
                    ...
                    if (eOpts[0].data.name === 'Incipits') {
                        ...
                        me.incipitsPanel = new TheaterTool.view.tabPanel.repertoire.incipits.IncipitsTabPanel({
                            sourceID: eOpts[0].parentNode.parentNode.data.werkID, title: '<font size="2" face="Tahoma" style="color:#909090;">Incipits für ' + eOpts[0].parentNode.data.name + '</font>'
                        });
                        me.repertoirePanel.add(me.incipitsPanel);
                        ...
                        me.rismPanel = new TheaterTool.view.tabPanel.repertoire.rism.RISMPanel({
                            sourceID: eOpts[0].parentNode.parentNode.data.werkID, title: eOpts[0].parentNode.data.name, title: '<font size="2" face="Tahoma" style="color:#909090;">Beschreibung für ' + eOpts[0].parentNode.data.name + '</font>'
                        });
                    ...
                    me.beatPanel = new TheaterTool.view.tabPanel.repertoire.beat.BeatPanel({
                        sourceID: eOpts[0].parentNode.parentNode.data.sourceID, selectedWork: eOpts[0].parentNode.parentNode.parentNode.data.werkID, xmlId: eOpts[0].data.xmlid, title: '<font size="2" face="Tahoma" style="color:#909090;">Faksimiles für ' + eOpts[0].data.name + ' (' + eOpts[0].parentNode.parentNode.data.name + ')</b>'
                    });
                    me.repertoirePanel.add(me.beatPanel);
                }
        ...
        this.columns =[ {
            xtype: 'treecolumn',
            header: '<font style="color:#585858;">Werk -> Quelle -> Beschreibung/Incipits/Faksimiles</font>',
            flex: 2.3,
            style: {
         paddingLeft: 6,
         paddingTop: 6,
        ...
        dataIndex: 'language'
            ...
            header: '<font style="color:#585858;">Personen</font>',
            flex: 1.5,
            sortable: true,
            menuDisabled: true,
            style: {
