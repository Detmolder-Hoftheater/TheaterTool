...
style: {
  ...
  /*  features: [{
    ...
    me.personTable = new TheaterTool.view.tabPanel.repertoire.work.RevenueTable();
    me.repertoireTab = new TheaterTool.view.tabPanel.repertoire.work.RevenueDetailsTabPanel();
