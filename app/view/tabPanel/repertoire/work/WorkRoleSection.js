 ...
 */
Ext.define('TheaterTool.view.tabPanel.repertoire.work.WorkRoleSection', {
...
style: {
  ...
  /*  features: [{
    ...
    me.personTable = new TheaterTool.view.tabPanel.repertoire.work.RoleTable();
    me.repertoireTab = new TheaterTool.view.tabPanel.repertoire.work.RoleDetailsTabPanel();
