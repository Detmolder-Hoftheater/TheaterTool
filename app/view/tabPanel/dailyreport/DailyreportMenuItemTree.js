Ext.define('TheaterTool.view.tabPanel.dailyreport.DailyreportMenuItemTree', {
		...
		this.listeners = {
			...
			selectionchange: function (selected, eOpts) {			
				if (typeof eOpts[0] !== 'undefined') {	
					...
					me.workPanel = new TheaterTool.view.tabPanel.dailyreport.DailyreportPanelDetails({issueName: eOpts[0].data.name, year:me.year});
