...
for(i = 0; i < me.worksList.length; i++){
            ...
            var iconExtend = 'resources/images/Books1-17.png';
            ...
            if(nameTypeShort === 'uniform'){
                    nameTypeLong = GUI_NAMES.work_NameType_uni;
					}
					else if(nameTypeShort === 'alt'){
					nameTypeLong = GUI_NAMES.work_NameType_alt;
					}
		...
		{
			text:GUI_NAMES.work_SectionName,
			flex: 0.7,
			menuDisabled: true,
			dataIndex: 'nametype'
		...
		{
			text: GUI_NAMES.search_works_table_lang,
			flex: 0.7,
			menuDisabled: true,
			dataIndex: 'language'
		...
		{
			text: GUI_NAMES.work_SectionPersons,
			flex: 2,
			menuDisabled: true,
			dataIndex: 'personen'
