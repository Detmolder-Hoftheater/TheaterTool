...
style: {
  ...
  /*  features: [{
    ...
    me.personTable = new TheaterTool.view.tabPanel.repertoire.work.RegieTable();
    me.repertoireTab = new TheaterTool.view.tabPanel.repertoire.work.RegieDetailsTabPanel();
