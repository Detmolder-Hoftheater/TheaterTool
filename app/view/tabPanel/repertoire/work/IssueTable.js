    ...
    createColumn: function (headerName, path) {
        ...
        getIssueContent = function (jahr, issueName) {
            ...
            var menuItem = historyButton.menu.add({
                text: '<font style="color:gray;">' + issueName + '</font>', icon: 'resources/images/MoneyTransfer-17.png'
            });
            //, selection: 3
            ...
            if (! isFoundItem) {
                ...
                var personDetails = new TheaterTool.view.tabPanel.issue.IssuePanelInTab({
                    issueName: issueName, year: jahrSplitted, selectedWorkID: me.selectedWorkID
                });
