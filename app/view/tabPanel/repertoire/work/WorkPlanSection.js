...
Ext.define('TheaterTool.view.tabPanel.repertoire.work.WorkPlanSection', {
 ...
 //  margin: '5 0 5 0',
  ...
  /*  features: [{
    ...
    this.personTable = new TheaterTool.view.tabPanel.repertoire.work.PlanTable();
    this.repertoireTab = new TheaterTool.view.tabPanel.repertoire.work.PlanDetailsTabPanel();
