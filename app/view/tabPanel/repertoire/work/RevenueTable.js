    ...
    createColumn: function (headerName, path) {
        ...
        getRevenueContent = function (jahr, monat) {
            ...
            var menuItem = historyButton.menu.add({
                text: '<font style="color:gray;">'+GUI_NAMES.work_SectionRevenues_tailName+': ' + monat + ', ' + jahr + '</font>', icon: 'resources/images/MoneyBox-17.png'
            });
            //, selection: 3
            ...
            var isFoundItem = navTreeGlobal.isItemFound(existItems, '<font style="color:gray;">'+GUI_NAMES.work_SectionRevenues_tailName+': '  + monat + ', ' + jahr + '</font>', menuItem.id);
            if (! isFoundItem) {
                var repertoireTab = new TheaterTool.view.tabPanel.HTTab({
                    title: '<font style="color:gray;">'+GUI_NAMES.work_SectionRevenues_tailName+': '  + monat + ', ' + jahr + '</font>',
                    icon: 'resources/images/MoneyBox-17.png'
                });
