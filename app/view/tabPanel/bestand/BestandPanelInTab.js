Ext.define('TheaterTool.view.tabPanel.bestand.BestandPanelInTab', {
    ...
    initComponent: function () {
        ...
        me.icon = 'resources/images/openBox1.png';
                    ...
                    listeners: {
                        click: function (item, e, eOpts) {
                            ...
                            Ext.Ajax.request({
                                ...
                                url: 'resources/xql/getBestandXML.xql',
                                method: 'GET',
                                params: {
        ...
        var section_details = new TheaterTool.view.tabPanel.bestand.BestandTabDetails({
