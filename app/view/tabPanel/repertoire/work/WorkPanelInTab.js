Ext.define('TheaterTool.view.tabPanel.repertoire.work.WorkPanelInTab', {
    ...
    initComponent: function () {
        ...
        navTreeStore.getProxy().extraParams.path = dbPathsMap. get ('works');
        navTreeStore.load();
        ...
        if (me.sourceId === null) {
            workPanel = new TheaterTool.view.tabPanel.repertoire.work.WorkPanelDetails({
                workID: me.selection//, title: '<font size="2" face="Arial" style="color:#A87678;">Werk: ' + me.workName + '</font>', icon: me.workIcon
            });
            ...
            workPanel = new TheaterTool.view.tabPanel.repertoire.source.SourcePanel({
                sourceID: me.sourceId, werkTitle: '<font size="2" face="Tahoma" style="color:#909090;">Werk: ' + me.workName + '</font>', title: '<font size="2" face="Arial" style="color:#909090;">' + me.sourceTitle + '</font>', firstTabTitle: me.selLocation, icon: me.workIcon
            });
            repertoirePanel.add(workPanel);
        }
